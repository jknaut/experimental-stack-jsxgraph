    ...
    */
    ...
    if (options.showStaticAsyncSOK) {
        ...
        if (options.showBP) {
            ...
            board.create('arrow', [pOrig, pBP], { withLabel: true, name: () => "Teil (c), Length: " + JXG.Math.Geometry.distance([pOrig.X(), pOrig.Y()], [pBP.X(), pBP.Y()], 2).toFixed(2) + " cm", strokeColor: "darkred", label: { anchorY: 'middle', anchorX: 'middle', strokeColor: "darkred" } });
